    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entire_amount', models.PositiveIntegerField()),
                ('is_given', models.BooleanField(default=False)),
                ('is_extended_refund', models.BooleanField(default=False)),
                ...
                ('salary', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refund', to='salaryapp.salary')),
