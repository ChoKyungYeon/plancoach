...
from profileapp.views import ProfileTuitionUpdateView, ProfileDetailView, ProfileStateUpdateView, \
    ProfileListView, ProfileCreateView, ProfileDeleteView, ProfileHighlightUpdateView
...
urlpatterns = [
    ...
    path('highlightupdate/',ProfileHighlightUpdateView.as_view(), name='highlightupdate'),
